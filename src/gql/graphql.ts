...
export type Applet = AbstractEntity &
  AbstractRepository &
...
export type AppletRevision = AbstractEntityRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type Article = AbstractEntity &
  AbstractRepository &
  AbstractTaxonomyTermChild &
  AbstractUuid &
  InstanceAware &
...
export type ArticleRevision = AbstractEntityRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type Course = AbstractEntity &
  AbstractRepository &
  AbstractTaxonomyTermChild &
  AbstractUuid &
  InstanceAware &
...
export type CoursePage = AbstractEntity &
  AbstractRepository &
  AbstractUuid &
  InstanceAware &
  ThreadAware & {
...
export type CoursePageRevision = AbstractEntityRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type CourseRevision = AbstractEntityRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type Event = AbstractEntity &
  AbstractRepository &
  AbstractTaxonomyTermChild &
  AbstractUuid &
  InstanceAware &
...
export type EventRevision = AbstractEntityRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type Exercise = AbstractEntity &
  AbstractExercise &
  AbstractRepository &
  AbstractTaxonomyTermChild &
  AbstractUuid &
...
export type ExerciseGroup = AbstractEntity &
  AbstractRepository &
  AbstractTaxonomyTermChild &
  AbstractUuid &
  InstanceAware &
...
export type ExerciseGroupRevision = AbstractEntityRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type ExerciseRevision = AbstractEntityRevision &
...
export type GroupedExercise = AbstractEntity &
  AbstractExercise &
  AbstractRepository &
  AbstractUuid &
  InstanceAware &
...
export type GroupedExerciseRevision = AbstractEntityRevision &
  AbstractExerciseRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type Page = AbstractNavigationChild &
  AbstractRepository &
  AbstractUuid &
  InstanceAware &
  ThreadAware & {
...
export type PageRevision = AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type Solution = AbstractEntity &
  AbstractRepository &
  AbstractUuid &
  InstanceAware &
  ThreadAware & {
...
export type SolutionRevision = AbstractEntityRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
...
export type TaxonomyTerm = AbstractNavigationChild &
  AbstractUuid &
  InstanceAware &
  ThreadAware & {
...
export type Video = AbstractEntity &
  AbstractRepository &
  AbstractTaxonomyTermChild &
  AbstractUuid &
  InstanceAware &
...
export type VideoRevision = AbstractEntityRevision &
  AbstractRevision &
  AbstractUuid &
  ThreadAware & {
    ...
    nodes: Array<{
      ...
      event:
        | {
            __typename: 'CheckoutRevisionNotificationEvent'
            date: any
            actor: { __typename?: 'User'; username: string }
          }
        | {
            __typename: 'CreateCommentNotificationEvent'
            date: any
...
export const GetNotificationsDocument: RequestDocument = {
  kind: 'Document',
  definitions: [
    {
